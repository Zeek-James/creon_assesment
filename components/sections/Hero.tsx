...
const Hero = () => {
  return (
    ...
    min-h-[100vh] md:min-h-screen bg-[url('https://res.cloudinary.com/dnir0cslk/image/upload/v1700497529/main-video-gradient.195ff22ca768f7dc4ce8_1_3_vdg1nn.png')] bg-no-repeat bg-cover bg-center grid grid-cols-1 gap-8  text-[#fff]"
    >
      <section className='hero h-full'></section>
      <section className=' flex flex-col gap-4  absolute bottom-0 md:top-96 p-6 md:p-16 z-10 shadow-2xl backdrop-blur-sm bg-black/30 h-fit'>
